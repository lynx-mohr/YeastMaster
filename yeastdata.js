const yeastDatabase = {
  "yeasts": [
    ...
    { "s": "S-04", "p": "Standard", "steps": [[0, 18.0], [3, 20.0], [7, 21.0], [14, 2.0]] },
    ...
    { "s": "Voss Kveik", "p": "Hot & Fast", "steps": [[0, 38.0], [2, 38.0], [4, 38.0], [7, 4.0]] },
    { "s": "Voss Kveik", "p": "Clean Pseudo", "steps": [[0, 25.0], [3, 28.0], [6, 28.0], [10, 4.0]] },
    
    { "s": "Nottingham", "p": "Standard Ale", "steps": [[0, 18.0], [4, 20.0], [7, 21.0], [14, 2.0]] },
    ...
    { "s": "Diamond", "p": "Clean Lager", "steps": [[0, 10.0], [8, 11.0], [14, 16.0], [28, 2.0]] },
    ...
    { "s": "Belle Saison", "p": "Dry & Peppery", "steps": [[0, 20.0], [3, 25.0], [7, 28.0], [14, 3.0]] },
    ...
    { "s": "English Ale", "p": "Standard", "steps": [[0, 18.5], [3, 20.0], [7, 21.0], [14, 2.0]] },
