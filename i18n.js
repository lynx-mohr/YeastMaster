...
const translations = {
    en: {
        ...
        privacy: {
            ...
            s1_title: "Who we are",
            s1_body: "YeastMaster is a fermentation monitoring service operated by AY Tech. For questions regarding your personal data, contact:",
   ...
   hint: "Main Menu -> Settings -> MAC-ID"
    ...
    sv: {
        ...
        privacy: {
            ...
            s1_title: "Vem vi är",
            s1_body: "YeastMaster är en fermenteringsövervakningstjänst driven av AY Tech. Vid frågor om dina personuppgifter, kontakta:",
...
libTour: {
    ...
    de: {
        ...
        privacy: {
            ...
            s1_body: "YeastMaster ist ein Gärüberwachungsdienst, betrieben von AY Tech. Bei Fragen zu deinen personenbezogenen Daten wende dich an:",
...
libTour: {
    ...
    fr: {
        ...
        lab: {
            title: "Le Profileur",
            info_1: "Choisissez une souche, puis attrapez et faites glisser les points pour façonner votre courbe de fermentation.",
            info_2: "Enregistrez une fois terminé — votre profil arrive directement dans la Bibliothèque de levures.",
            info_3: "N'oubliez pas le houblonnage à cru !",
            profile_name: "NOM DU PROFIL",
            ...
            chart_placeholder: "Choisissez une levure de base et nommez votre profil ci-dessus 👆",
        ...
        privacy: {
            ...
            s1_body: "YeastMaster est un service de surveillance de fermentation exploité par AY Tech. Pour toute question concernant vos données personnelles, contactez :",
            s2_title: "Quelles données nous collectons",
            s2_body: "Nous collectons les données personnelles suivantes lorsque vous utilisez YeastMaster :",
            s2_li1: "Votre adresse e-mail (via Google ou connexion e-mail/mot de passe)",
            s2_li2: "Un identifiant utilisateur unique attribué par Firebase Authentication",
            s2_li3: "Les données de fermentation envoyées par votre appareil YeastMaster (température, jour, phase, nom de la souche, nom du profil)",
            s2_li4: "Les identifiants de l'appareil (adresse MAC, nom de l'appareil)",
            s2_li5: "Votre bibliothèque de levures (souches personnalisées et profils de fermentation que vous créez)",
            s2_li6: "L'abonnement aux notifications push (si vous activez les alertes)",
            s3_title: "Pourquoi nous les collectons",
            s3_body: "Vos données sont utilisées uniquement pour fournir le service YeastMaster : authentifier votre compte, stocker vos appareils et votre bibliothèque dans le cloud, afficher les données de fermentation en temps réel et envoyer les alertes auxquelles vous avez souscrit. Nous ne vendons ni ne partageons vos données avec des tiers à des fins marketing.",
            s4_title: "Où les données sont stockées",
            s4_body: "Les identifiants de compte sont gérés par Google Firebase Authentication (accord de traitement des données de l'UE en place). Les données de fermentation, les appareils et votre bibliothèque sont stockés dans une base de données MongoDB hébergée par MongoDB Atlas. Les abonnements aux notifications push sont traités via web-push.",
            s5_title: "Vos droits",
            s5_body: "Conformément au RGPD, vous avez le droit d'accéder à vos données personnelles, de les corriger ou de les supprimer à tout moment. Vous pouvez supprimer votre compte et toutes les données associées directement dans l'application sous Réglages → Supprimer le compte et toutes les données. Pour toute autre demande, contactez-nous à",
            s6_title: "Cookies et stockage local",
            s6_body: "YeastMaster utilise le stockage local du navigateur pour mémoriser votre session de connexion, votre préférence linguistique, votre unité de température et votre couleur d'accent. Aucun cookie de suivi tiers n'est utilisé."
        },
        ...
        soul: {
            ...
            desc2: "Soulof.beer est un hommage à cette magie biologique. Que vous soyez ici pour explorer notre bibliothèque de souches historiques ou pour prendre le contrôle total de votre fermentation, voici votre laboratoire. Surveillez votre brassin en temps réel, synchronisez des profils personnalisés vers votre unité YeastMaster et maîtrisez l'art de la fermentation.",
            what_is: "Qu'est-ce que YeastMaster ?",
            what_desc: "Découvrez le matériel et les fonctionnalités de l'application.",
            prompt: "Prêt à gérer votre bibliothèque ou à surveiller votre unité ?",
        ...
        library: {
            ...
            info_2: "<strong>Double-cliquez</strong> (ou appui long) sur une carte pour en savoir plus sur la souche et les profils Yeastmaster.",
            info_3: "Sélectionnez jusqu'à 10 favoris et synchronisez-les directement vers votre unité YeastMaster !",
        ...
        calc: {
            ...
            choose: "Choisissez votre source de levure :",
            ...
            slurry_info_tip: "Astuce de pro : en cas de doute, choisissez « Liquide ». Ensemencer un peu plus de boue est plus sûr que sous-ensemencer !"
        },

        tour: {
            welcome: "Bienvenue dans la VUE EN DIRECT !",
            p1: "Voici votre centre de commande numérique. Une fois votre YeastMaster connecté, vous pouvez surveiller votre fermentation active en temps réel, de n'importe où dans le monde.",
            p2: "Toutes les statistiques vitales sont transmises directement vers ce tableau de bord, vous offrant un contrôle total et une tranquillité d'esprit.",
            p3: "Vous voulez un tour rapide de l'interface ?",
        ...
        about: {
            back: "← RETOUR",
            title: "YEASTMASTER",
            desc: "Prenez le contrôle absolu de votre fermentation. YeastMaster est une unité matérielle dédiée et un écosystème cloud conçus pour le brasseur amateur moderne, comblant le fossé entre l'art biologique du brassage et le contrôle précis des données.",
            hw_title: "📟 L'unité matérielle",
            hw_desc: "Un contrôleur physique dédié avec un écran OLED net. Cliquez pour découvrir comment il contrôle votre frigo et votre élément chauffant.",
            cloud_title: "☁️ L'application cloud",
            free: "GRATUIT",
            cloud_desc: "Surveillez votre fermentation de n'importe où dans le monde. Créez des profils de température personnalisés dans le Profileur, gérez vos calendriers de houblonnage à cru et synchronisez tout sans effort.",
            lib_title: "🔬 La bibliothèque de levures",
            lib_desc: "Arrêtez de deviner. Découvrez notre guide en constante expansion des souches de levure les plus populaires au monde et apprenez à révéler les arômes parfaits pour votre bière."
        },
        about_lib: {
            title: "LA BIBLIOTHÈQUE DE LEVURES",
            desc: "Un décodeur pour le monde de la microbiologie brassicole. Nous ne vendons pas de levure — nous vous aidons à la maîtriser.",
            card1_title: "🕵️‍♂️ Déchiffrer le code",
            card1_p1: "Si vous débutez en brassage, des noms comme <strong>WLP001</strong> ou <strong>Wyeast 1056</strong> peuvent ressembler à des mots de passe secrets. Voici la traduction :",
            ...
            card2_p1: "N'importe quelle levure peut transformer le sucre en alcool. Mais <em>le goût</em> de la bière dépend entièrement de la température. Une levure belge fermentée à 18 °C peut avoir un goût de poire net, mais si vous la laissez monter à 25 °C, elle explose de poivre noir épicé et de chewing-gum.",
        ...
        about_cloud: {
            ...
            desc: "Contrôle total de votre fermenteur, où que vous soyez. YeastMaster est votre œil numérique à l'intérieur du fermenteur, offrant une surveillance en temps réel de la température et de l'état, pour que vous puissiez toujours être serein quant à votre brassin.",
            card1_title: "📡 Surveillance mondiale",
            card1_p1: "Que vous soyez au travail, sur le canapé ou en vacances, le tableau de bord en direct vous garde connecté à votre brassin. Regardez la courbe de température se dessiner en temps réel, vérifiez l'air ambiant de votre frigo et profitez d'une tranquillité d'esprit absolue en sachant exactement quelle phase votre levure traverse actuellement.",
            ...
            card2_p2: "Dans <strong>le Profileur</strong>, vous pouvez glisser-déposer visuellement des points de données pour créer des courbes de température personnalisées. Vous voulez ensemencer la levure à froid, laisser la température monter naturellement pendant la fermentation active, et déclencher automatiquement un choc à froid au jour 10 ? Dessinez simplement la courbe, enregistrez-la et synchronisez-la avec votre frigo.",
            card3_title: "🎓 Le Labo & l'Académie",
            card3_p1: "L'application cloud ne sert pas qu'à la surveillance. Rendez-vous dans <strong>le Labo</strong> pour accéder à des calculateurs d'ensemencement professionnels, ou explorez <strong>l'Académie</strong> pour des leçons interactives, étape par étape, qui vous feront passer de débutant complet à dompteur de levure confiant en un rien de temps."
        },
        about_hw: {
            title: "LE MATÉRIEL",
            desc: "YeastMaster est construit autour d'un cerveau ESP32 sur mesure, conçu pour se poser parfaitement sur votre chambre de fermentation. Il fonctionne 100 % localement, ce qui signifie que votre bière est en sécurité même si le WiFi tombe.",
            card1_title: "📺 Interface OLED rétro",
            card1_p1: "Un écran OLED à fort contraste associé à un encodeur rotatif tactile vous offre une interface classique, de qualité laboratoire. Ajustez les décalages, changez de profil de levure ou déclenchez un choc à froid directement au frigo.",
            ...
            card3_p1: "Aucun câblage haute tension dangereux. YeastMaster envoie des signaux radio 433 MHz directement à des prises connectées sans fil. Une pour votre frigo (refroidissement) et une pour un tapis chauffant (chauffage). Contrôle total, zéro risque électrique."
        },

        academy: {
            title: "Au labo",
            info_title: "Académie de gestion des levures",
            info_1: "Retroussez vos manches et devenez microbiologiste !",
            info_2: "Entrez dans le Labo et découvrez le monde fascinant de la gestion des levures.",
            hero_tag: "Commencez ici",
            hero_title: "Bienvenue au Labo",
            hero_desc: "Vous êtes déjà microbiologiste. Installons votre labo de cuisine et commençons à récolter l'or liquide.",
            hero_btn: "COMMENCER ➔",
            calc_title: "Calculateurs d'ensemencement",
            calc_desc: "Calculez les taux d'ensemencement optimaux et les étapes de pied de cuve.",
            washing_title: "Lavage de levure 101",
            washing_desc: "Lavez le gâteau de levure et récoltez l'« or liquide » (boue).",
            starters_title: "Pieds de cuve 101",
            starters_desc: "Réveillez votre levure et assurez une fermentation saine.",
            ...
            agar_desc: "Apprenez à couler, strier et isoler des souches pures.",
            wild_title: "Capturer la levure sauvage",
            wild_desc: "Chassez les microbes locaux et brassez quelque chose d'unique.",
        ...
        house_bank: {
            title: "Banque maison",
            desc: "Cataloguez vos captures sauvages, vos mélanges maison ou vos souches de levure locales.",
        ...
        settings: {
            ...
            push_desc: "Activez les notifications push pour recevoir des alertes sur votre téléphone concernant les variations de température, les coupures de courant ou le moment du houblonnage à cru.",
            ...
            delete_confirm_1: "Cela supprimera définitivement votre compte et toutes vos données (appareils, bibliothèque de levures, journaux de fermentation). Cette action est irréversible.\n\nÊtes-vous sûr ?",
        ...
        claim: {
            ...
            desc: "Saisissez l'ID MAC depuis le menu réglages de l'appareil",
        ...
        alerts: {
            ...
            power: "⚠️ CONNEXION PERDUE ! Vérifiez l'alimentation/le WiFi.",
            temp: "🔥 ÉCART DE TEMPÉRATURE ! Différence > 2,0 °C.",
            login_add_device: "Vous devez vous connecter pour associer un appareil YeastMaster à votre compte."
        },

        support: {
            title_bug: "Signaler un bug",
            title_idea: "Proposer une idée",
            desc: "Vos idées et rapports de bugs nous aident à brasser une meilleure application !",
            email: "Votre e-mail",
            subject: "Sujet",
            message: "Message",
            btn_send: "Envoyer le message",
            success_title: "Envoyé !",
            success_desc: "Merci pour votre retour. Nous vous recontacterons !",
            sub_bug: "Rapport de bug - YeastMaster",
            sub_idea: "Demande de fonctionnalité - YeastMaster",
            message_placeholder: "Dites-nous ce qui s'est passé ou partagez votre idée..."
        },

        libTour: {
            noYeast: "Sélectionnez ou ajoutez d'abord des levures pour voir la visite !",
            exitConfirm: "QUITTER LA VISITE ?",
            step1: "Double-cliquez sur une carte pour en savoir plus sur la souche. Un simple clic pour la sélectionner pour votre appareil !",
            step2: "Voici les profils matériels. Ils contrôlent automatiquement les températures de votre frigo.",
            step3: "Cliquez pour développer le profil et voir les étapes de température !",
            step4: "Envie de modifier un profil ? Cliquez sur « Modifier dans le Profileur » pour ajouter des houblonnages à cru ou des alarmes de soutirage !",
            step5: "Bienvenue dans le Profileur ! Ici, vous pouvez attraper et faire glisser les points pour façonner votre courbe de fermentation.",
            step6: "Réglez vos alarmes pour le houblonnage à cru, le retrait des houblons et le soutirage ! Elles apparaîtront sur votre chronologie et vous alerteront le moment venu.",
            step7: "Une fois enregistré, votre profil modifié arrive en bas de la bibliothèque avec une étoile ★, prêt à être synchronisé !",
            step8: "Dans la bibliothèque, vous avez la possibilité d'ajouter vos propres captures uniques et levures sauvages.",
            step9: "Vous pouvez suivre les dates de capture, les origines et tenir des notes de labo personnelles pour chaque levure sauvage que vous trouvez !",
            step10: "Vos captures sauvages vivent en sécurité tout en bas de votre bibliothèque, juste à côté de vos profils modifiés !",
            step11: "Visite terminée ! Vous êtes maintenant prêt à maîtriser la bibliothèque de levures. 🍻 Cliquez n'importe où pour terminer."
        },
    }
};
