...
const translations = {
    en: {
        ...
        dashboard: { 
            ...
            fridge: "FRIDGE",
            last_sync: "LAST SYNC",
            no_data_hint: "No data received yet. Make sure the device is powered on and connected to WiFi — and double-check that the MAC address is correct.",
            start: "START",
            ready: "READY",
            air: "Air:",
            phase_label: "Phase:",
        ...
        privacy: {
            ...
            s1_title: "Who we are",
            s1_body: "YeastMaster is a fermentation monitoring service operated by AY Tech. For questions regarding your personal data, contact: <a href='mailto:yeastmaster101@gmail.com' style='color: var(--accent-color);'>yeastmaster101@gmail.com</a>",
   ...
   hint: "Main Menu -> Settings -> MAC-ID"
    ...
    sv: {
        ...
        dashboard: { 
            ...
            no_data_hint: "Ingen data mottagen än. Kontrollera att enheten är påslagen och WiFi-ansluten — och dubbelkolla att MAC-adressen stämmer.",
            start: "START",
            ready: "KLAR",
            air: "Luft:",
            phase_label: "Fas:",
        ...
        privacy: {
            ...
            s1_title: "Vem vi är",
            s1_body: "YeastMaster är en fermenteringsövervakningstjänst driven av AY Tech. Vid frågor om dina personuppgifter, kontakta: <a href='mailto:yeastmaster101@gmail.com' style='color: var(--accent-color);'>yeastmaster101@gmail.com</a>",
...
libTour: {
    ...
    de: {
        ...
        dashboard: { 
            ...
            no_data_hint: "Noch keine Daten empfangen. Stell sicher, dass das Gerät eingeschaltet und mit dem WLAN verbunden ist — und überprüf, ob die MAC-Adresse stimmt.",
            start: "START",
            ready: "FERTIG",
            air: "Luft:",
            phase_label: "Phase:",
        ...
        privacy: {
            ...
            s1_body: "YeastMaster ist ein Gärüberwachungsdienst, betrieben von AY Tech. Bei Fragen zu deinen personenbezogenen Daten wende dich an: <a href='mailto:yeastmaster101@gmail.com' style='color: var(--accent-color);'>yeastmaster101@gmail.com</a>",
...
libTour: {
    ...
    fr: {
        nav: { home: "ACCUEIL", library: "LEVURES", lab: "LABO", profiler: "PROFILEUR", live: "DIRECT", settings: "RÉGLAGES" },
        dashboard: {
            progress: "PROGRESSION",
            since_start: "Depuis le début",
            time_phase: "Temps dans la phase",
            goal_temp: "Temp. cible de la phase",
            history: "HISTORIQUE TEMP.",
            fridge: "FRIGO",
            last_sync: "DERNIÈRE SYNCHRO",
            no_data_hint: "Aucune donnée reçue pour l'instant. Vérifie que l'appareil est allumé et connecté au WiFi — et revérifie que l'adresse MAC est correcte.",
            start: "DÉBUT",
            ready: "PRÊT",
            air: "Air :",
            phase_label: "Phase :",
        ...
        profiler: {
            ...
            profile_builder: "ÉDITEUR DE PROFIL",
            overview: "VUE D'ENSEMBLE",
            summary: "RÉSUMÉ DU PROFIL",
            name_placeholder: "Ma Lager...",
            pick_yeast: "Choisir une levure de base...",
            save: "ENREGISTRER DANS LA BIBLIOTHÈQUE",
            day: "Jour",
            hold_until: "Maintenir jusqu'au jour",
            free_rise: "Montée libre vers",
            drop_to: "Descendre à",
            reach: "Atteindre",
            rise_to: "Monter à",
            by_day: "pour le jour",
            ...
            primary: "Primaire",
            cleanup: "Nettoyage",
            cold_crash: "Choc à froid",
            condition: "Maturation",
            created_by_you: "Créé par toi !",
            used_with: "Ce profil est utilisé avec",
            profile_steps_are: "et voici les étapes du profil :",
            start_at: "Démarrer à",
            free_rise_to: "Montée libre vers",
            dry_hop_contact: "Contact houblonnage à cru",
            days_plural: "jours"
        },

        lab: {
            title: "Le Profileur",
            info_1: "Choisis une souche, puis attrape et fais glisser les points pour façonner ta courbe de fermentation.",
            info_2: "Enregistre une fois terminé — ton profil arrive directement dans la Bibliothèque de levures.",
            info_3: "N'oublie pas le houblonnage à cru !",
            profile_name: "NOM DU PROFIL",
            profile_name_placeholder: "ex. JUICEBMB",
            pick_strain: "Choisir une souche",
            builder_title: "ÉDITEUR DE PROFIL",
            btn_overview: "🔍 VUE D'ENSEMBLE",
            chart_placeholder: "Choisis une levure de base et nomme ton profil ci-dessus 👆",
            summary_title: "RÉSUMÉ DU PROFIL",
            phase_pitch: "Ensemencement",
            phase_primary: "Primaire",
            phase_cleanup: "Nettoyage",
            phase_crash: "Choc à froid",
            phase_condition: "Maturation",
            day: "Jour ",
            hold_until: "Maintenir jusqu'au jour",
            reach: "Atteindre",
            drop_to: "Descendre à",
            by_day: "pour le jour",
            btn_add_hops: "+ AJOUTER HOUBLONNAGE À CRU",
            btn_add_dump: "+ SOUTIRAGE / PURGE",
            schedule_hop: "Houblonnage à cru prévu le jour",
            schedule_dump: "Soutirage / Purge prévu le jour",
            fullscreen: "PLEIN ÉCRAN",
            btn_remove_hops: "- RETIRER HOUBLONNAGE À CRU",
            btn_remove_dump: "- RETIRER L'ACTION",
            chart_dry_hop: "HOUBLON À CRU",
            chart_rack: "SOUTIRAGE/PURGE",
            btn_add_remove_hops: "+ RETIRER HOUBLONS",
            btn_remove_remove_hops: "- RETIRER HOUBLONS",
            schedule_remove_hop: "Retrait des houblons prévu le jour",
            chart_remove_hop: "RETIRER HOUBLONS 🔔",
            btn_save: "ENREGISTRER LE PROFIL",
            btn_saved_success: "ENREGISTRÉ ! ✓"
        },

        login: {
            btn: "Se connecter avec Google",
            btn_email: "Se connecter",
            create_account: "Créer un compte",
            forgot: "Mot de passe oublié ?",
            or: "ou",
            create_title: "Créer un compte",
            password_hint: "Mot de passe (min. 6 caractères)",
            confirm_hint: "Confirmer le mot de passe",
            register_btn: "Créer un compte",
            back_login: "← Retour à la connexion",
            reset_title: "Réinitialiser le mot de passe",
            reset_btn: "Envoyer le lien de réinitialisation"
        },
        ...
        privacy: {
            ...
            s1_title: "Qui sommes-nous",
            s1_body: "YeastMaster est un service de surveillance de fermentation exploité par AY Tech. Pour toute question concernant tes données personnelles, contacte : <a href='mailto:yeastmaster101@gmail.com' style='color: var(--accent-color);'>yeastmaster101@gmail.com</a>",
            s2_title: "Quelles données nous collectons",
            s2_body: "Nous collectons les données personnelles suivantes lorsque tu utilises YeastMaster :",
            s2_li1: "Ton adresse e-mail (via Google ou connexion e-mail/mot de passe)",
            s2_li2: "Un identifiant utilisateur unique attribué par Firebase Authentication",
            s2_li3: "Les données de fermentation envoyées par ton appareil YeastMaster (température, jour, phase, nom de la souche, nom du profil)",
            s2_li4: "Les identifiants de l'appareil (adresse MAC, nom de l'appareil)",
            s2_li5: "Ta bibliothèque de levures (souches personnalisées et profils de fermentation que tu crées)",
            s2_li6: "L'abonnement aux notifications push (si tu actives les alertes)",
            s3_title: "Pourquoi nous les collectons",
            s3_body: "Tes données sont utilisées uniquement pour fournir le service YeastMaster : authentifier ton compte, stocker tes appareils et ta bibliothèque dans le cloud, afficher les données de fermentation en temps réel et envoyer les alertes auxquelles tu as souscrit. Nous ne vendons ni ne partageons tes données avec des tiers à des fins marketing.",
            s4_title: "Où les données sont stockées",
            s4_body: "Les identifiants de compte sont gérés par Google Firebase Authentication (accord de traitement des données de l'UE en place). Les données de fermentation, les appareils et ta bibliothèque sont stockés dans une base de données MongoDB hébergée par MongoDB Atlas. Les abonnements aux notifications push sont traités via web-push.",
            s5_title: "Tes droits",
        ...
        soul: {
            title: "LEVURE",
            subtitle: "L'âme de la bière",
            desc1_a: "Nous croyons que la véritable âme de la bière réside dans la levure. Comme le dit le vieil adage brassicole : ",
            desc1_quote: "« Le brasseur fait le moût, mais la levure fait la bière. »",
            desc1_b: " Il y a une merveille profonde dans la façon dont ces artisans microscopiques transforment un simple liquide sucré en l'élixir infiniment complexe et plein d'âme que nous appelons bière.",
            desc2: "Soulof.beer est un hommage à cette magie biologique. Que tu sois ici pour explorer notre bibliothèque de souches historiques ou pour prendre le contrôle total de ta fermentation, voici ton laboratoire. Surveille ton brassin en temps réel, synchronise des profils personnalisés vers ton unité YeastMaster et maîtrise l'art de la fermentation.",
            what_is: "Qu'est-ce que YeastMaster ?",
            what_desc: "Découvre le matériel et les fonctionnalités de l'application.",
            prompt: "Prêt à gérer ta bibliothèque ou à surveiller ton unité ?",
            btn_login: "ALLER À LA CONNEXION"
        },

        library: {
            title: "Bibliothèque de levures",
            info_1: "Parcourez la collection de souches de levure.",
            info_2: "<strong>Double-clique</strong> (ou appui long) sur une carte pour en savoir plus sur la souche et les profils Yeastmaster.",
            info_3: "Sélectionne jusqu'à 10 favoris et synchronise-les directement vers ton unité YeastMaster !",
            btn_tour: "✨ FAIRE UNE VISITE RAPIDE",
            selected: "Sélectionnés :",
            search_placeholder: "Rechercher (ex. « WLP », « IPA », « Stout »)...",
            btn_add_strain: "+ AJOUTER UNE SOUCHE MAISON / CAPTURE SAUVAGE",
            target_device: "APPAREIL CIBLE",
            loading_devices: "Chargement des appareils...",
            btn_sync: "SYNCHRONISER VERS L'APPAREIL SÉLECTIONNÉ",
            btn_edit: "MODIFIER LES DÉTAILS",
            btn_delete: "SUPPRIMER",
            included_profiles: "PROFILS MATÉRIELS INCLUS :",
            btn_edit_profiler: "MODIFIER DANS LE PROFILEUR"
        },

        calc: {
            title: "Calculateurs d'ensemencement",
            choose: "Choisis ta source de levure :",
            selected: "Sélectionné :",
            btn_change: "Changer",
            btn_dry: "Levure sèche",
            btn_liquid: "Levure liquide",
            btn_slurry: "Boue de levure",
            btn_bank: "Depuis la banque de levures",
            inoculation: "Méthode d'inoculation",
            btn_loop: "Boucle simple",
            btn_wash: "Lavage de gélose complète",
            batch_size: "Volume du lot (litres)",
            og: "Densité initiale (DI)",
            pitch_rate: "Taux d'ensemencement cible",
            rate_low: "0,35 (Faible / recommandation fabricant)",
            rate_std: "0,50 (Ale standard)",
            rate_pro: "0,75 (Ensemencement ale pro)",
            rate_high: "1,00 (Ale haute densité)",
            rate_lager: "1,50 (Lager standard)",
            btn_calc: "Calculer",
            results: "Résultats",
            cells_in_pack: "Cellules par sachet",
            mfg_date: "Date de fabrication",
            add_package: "+ Ajouter un autre sachet",
            cells_per_gram: "Cellules par gramme (milliards)",
            harvest_date: "Date de récolte",
            slurry_density: "Densité de la boue (épaisseur)",
            slurry_thin: "Liquide (~1,0 Md cellules/mL)",
            slurry_med: "Moyenne (~2,0 Md cellules/mL)",
            slurry_thick: "Épaisse (~3,0 Md cellules/mL)",
            slurry_info_thin: "💧 Liquide (aqueuse) :",
            slurry_info_thin_desc: "Ressemble à de l'eau de vaisselle sale. Coule facilement. Se produit quand elle n'est pas assez décantée.",
            slurry_info_med: "🥞 Moyenne (pâte à crêpes) :",
            slurry_info_med_desc: "Opaque, crémeuse, coule lentement. Le standard après lavage et choc à froid.",
            slurry_info_thick: "🧱 Épaisse (argile/mastic) :",
            slurry_info_thick_desc: "Difficile à verser, nécessite une cuillère. Levure très compactée du fond d'une cuve conique.",
            slurry_info_tip: "Astuce de pro : en cas de doute, choisis « Liquide ». Ensemencer un peu plus de boue est plus sûr que sous-ensemencer !"
        },

        tour: {
            welcome: "Bienvenue dans la VUE EN DIRECT !",
            p1: "Voici ton centre de commande numérique. Une fois ton YeastMaster connecté, tu peux surveiller ta fermentation active en temps réel, de n'importe où dans le monde.",
            p2: "Toutes les statistiques vitales sont transmises directement vers ce tableau de bord, t'offrant un contrôle total et une tranquillité d'esprit.",
            p3: "Tu veux un tour rapide de l'interface ?",
            btn_exit: "Quitter la démo",
            btn_start: "Continuer",
            step_beer: "Temp. dans la cuve",
            step_air: "Temp. ambiante",
            step_strain: "Souche de levure",
            step_profile: "Profil de fermentation",
            step_action: "Action",
            step_progress: "Avancement de la fermentation",
            step_phase: "Détails de la phase actuelle",
            step_chart: "Évolution de la temp. dans le temps"
        },

        about: {
            back: "← RETOUR",
            title: "YEASTMASTER",
            desc: "Prends le contrôle absolu de ta fermentation. YeastMaster est une unité matérielle dédiée et un écosystème cloud conçus pour le brasseur amateur moderne, comblant le fossé entre l'art biologique du brassage et le contrôle précis des données.",
            hw_title: "📟 L'unité matérielle",
            hw_desc: "Un contrôleur physique dédié avec un écran OLED net. Clique pour découvrir comment il contrôle ton frigo et ton élément chauffant.",
            cloud_title: "☁️ L'application cloud",
            free: "GRATUIT",
            cloud_desc: "Surveille ta fermentation de n'importe où dans le monde. Crée des profils de température personnalisés dans le Profileur, gère tes calendriers de houblonnage à cru et synchronise tout sans effort.",
            lib_title: "🔬 La bibliothèque de levures",
            lib_desc: "Arrête de deviner. Découvre notre guide en constante expansion des souches de levure les plus populaires au monde et apprends à révéler les arômes parfaits pour ta bière."
        },
        about_lib: {
            title: "LA BIBLIOTHÈQUE DE LEVURES",
            desc: "Un décodeur pour le monde de la microbiologie brassicole. Nous ne vendons pas de levure — nous t'aidons à la maîtriser.",
            card1_title: "🕵️‍♂️ Déchiffrer le code",
            card1_p1: "Si tu débutes en brassage, des noms comme <strong>WLP001</strong> ou <strong>Wyeast 1056</strong> peuvent ressembler à des mots de passe secrets. Voici la traduction :",
            card1_p2: "<strong>WLP</strong> signifie White Labs, et <strong>Wyeast</strong> est un autre laboratoire légendaire. Tous deux produisent de la levure <em>liquide</em> de premier ordre. Des noms comme <strong>SafAle</strong>, <strong>Fermentis</strong> et <strong>Lallemand</strong> sont de célèbres producteurs de levure <em>sèche</em>. Nous avons sélectionné les meilleures et les plus intéressantes souches commerciales de chacun et rassemblé leurs données en un seul endroit.",
            card2_title: "🌡️ Pourquoi la température est primordiale",
            card2_p1: "N'importe quelle levure peut transformer le sucre en alcool. Mais <em>le goût</em> de la bière dépend entièrement de la température. Une levure belge fermentée à 18 °C peut avoir un goût de poire net, mais si tu la laisses monter à 25 °C, elle explose de poivre noir épicé et de chewing-gum.",
            card2_p2: "Notre bibliothèque fournit des guides détaillés sur la façon de traiter chaque souche spécifique pour révéler les arômes parfaits (esters et phénols), y compris quand augmenter la température pour un « repos diacétyle » afin d'éliminer les faux-goûts de beurre."
        },
        about_cloud: {
            title: "L'APPLICATION CLOUD",
            desc: "Contrôle total de ton fermenteur, où que tu sois. YeastMaster est ton œil numérique à l'intérieur du fermenteur, offrant une surveillance en temps réel de la température et de l'état, pour que tu puisses toujours être serein quant à ton brassin.",
            card1_title: "📡 Surveillance mondiale",
            card1_p1: "Que tu sois au travail, sur le canapé ou en vacances, le tableau de bord en direct te garde connecté à ton brassin. Regarde la courbe de température se dessiner en temps réel, vérifie l'air ambiant de ton frigo et profite d'une tranquillité d'esprit absolue en sachant exactement quelle phase ta levure traverse actuellement.",
            card2_title: "📈 Le Profileur",
            card2_p1: "Les brasseurs professionnels maintiennent rarement leurs cuves à une température statique unique. La fermentation est un voyage.",
            card2_p2: "Dans <strong>le Profileur</strong>, tu peux glisser-déposer visuellement des points de données pour créer des courbes de température personnalisées. Tu veux ensemencer la levure à froid, laisser la température monter naturellement pendant la fermentation active, et déclencher automatiquement un choc à froid au jour 10 ? Dessine simplement la courbe, enregistre-la et synchronise-la avec ton frigo.",
            card3_title: "🎓 Le Labo & l'Académie",
            card3_p1: "L'application cloud ne sert pas qu'à la surveillance. Rends-toi dans <strong>le Labo</strong> pour accéder à des calculateurs d'ensemencement professionnels, ou explore <strong>l'Académie</strong> pour des leçons interactives, étape par étape, qui te feront passer de débutant complet à dompteur de levure confiant en un rien de temps."
        },
        about_hw: {
            title: "LE MATÉRIEL",
            desc: "YeastMaster est construit autour d'un cerveau ESP32 sur mesure, conçu pour se poser parfaitement sur ta chambre de fermentation. Il fonctionne 100 % localement, ce qui signifie que ta bière est en sécurité même si le WiFi tombe.",
            card1_title: "📺 Interface OLED rétro",
            card1_p1: "Un écran OLED à fort contraste associé à un encodeur rotatif tactile t'offre une interface classique, de qualité laboratoire. Ajuste les décalages, change de profil de levure ou déclenche un choc à froid directement au frigo.",
            card2_title: "🌡️ Double sonde de température",
            card2_p1: "La précision exige des données. YeastMaster utilise deux capteurs détachables et étanches. L'un mesure l'air ambiant du frigo, tandis que l'autre se place directement dans la bière (ou scotché au fermenteur), permettant à la logique PID d'éviter les fortes variations de température.",
            card3_title: "⚡ Relais sans fil",
            card3_p1: "Aucun câblage haute tension dangereux. YeastMaster envoie des signaux radio 433 MHz directement à des prises connectées sans fil. Une pour ton frigo (refroidissement) et une pour un tapis chauffant (chauffage). Contrôle total, zéro risque électrique."
        },

        academy: {
            title: "Au labo",
            info_title: "Académie de gestion des levures",
            info_1: "Retrousse tes manches et deviens microbiologiste !",
            info_2: "Entre dans le Labo et découvre le monde fascinant de la gestion des levures.",
            hero_tag: "Commence ici",
            hero_title: "Bienvenue au Labo",
            hero_desc: "Tu es déjà microbiologiste. Installons ton labo de cuisine et commençons à récolter l'or liquide.",
            hero_btn: "COMMENCER ➔",
            calc_title: "Calculateurs d'ensemencement",
            calc_desc: "Calcule les taux d'ensemencement optimaux et les étapes de pied de cuve.",
            washing_title: "Lavage de levure 101",
            washing_desc: "Lave le gâteau de levure et récolte l'« or liquide » (boue).",
            starters_title: "Pieds de cuve 101",
            starters_desc: "Réveille ta levure et assure une fermentation saine.",
            stirplate_title: "Agitateurs magnétiques 101",
            stirplate_desc: "Pourquoi les vortex magnétiques sont les meilleurs amis du brasseur.",
            counting_title: "Comptage cellulaire pro",
            counting_desc: "Utiliser microscopes et hémocytomètres comme un pro.",
            agar_title: "Maîtriser les boîtes de gélose",
            agar_desc: "Apprends à couler, strier et isoler des souches pures.",
            wild_title: "Capturer la levure sauvage",
            wild_desc: "Chasse les microbes locaux et brasse quelque chose d'unique.",
            btn_back: "← RETOUR À L'ACADÉMIE",
            btn_next: "Suivant ➔",
            btn_finish: "Terminer ! ✓"
        },
        ...
        house_bank: {
            title: "Banque maison",
            desc: "Catalogue tes captures sauvages, tes mélanges maison ou tes souches de levure locales.",
            strain_name: "Nom de la souche",
            strain_placeholder: "ex. Pomme sauvage du jardin",
            origin: "Origine / Source",
            origin_placeholder: "ex. Mon jardin",
            date: "Date de capture",
            temp: "Plage de température",
            temp_placeholder: "ex. 18-25 °C",
            tags: "Étiquettes (séparées par des virgules)",
            tags_placeholder: "ex. Acide, Funky, Ferme",
            notes: "Description / Notes",
            notes_placeholder: "Notes sur l'arôme, l'atténuation, l'historique...",
            save_btn: "Enregistrer dans la bibliothèque"
        },
        ...
        settings: {
            ...
            nickname: "Surnom",
            device_id: "ID de l'appareil (MAC)",
            remove: "Retirer l'appareil actif",
            add_device: "+ AJOUTER UN NOUVEAU YEASTMASTER",
            support: "SUPPORT & RETOURS",
            btn_bug: "SIGNALER UN BUG",
            btn_idea: "PROPOSER UNE IDÉE",
            btn_logout: "DÉCONNEXION",
            btn_delete_account: "Supprimer le compte et toutes les données",
            delete_confirm_1: "Cela supprimera définitivement ton compte et toutes tes données (appareils, bibliothèque de levures, journaux de fermentation). Cette action est irréversible.\n\nEs-tu sûr ?",
            delete_confirm_2: "Dernière chance — tout supprimer définitivement ?",
        ...
        claim: {
            ...
            desc: "Saisis l'ID MAC depuis le menu réglages de l'appareil",
            device_id: "ID de l'appareil",
            nick_placeholder: "Surnom (ex. Frigo 1 / Grande conique)",
            btn_activate: "ACTIVER LE NOUVEL APPAREIL",
            hint: "Menu principal -> Réglages -> ID MAC"
        },
        ...
        alerts: {
            dry_hop: "🌿 C'EST L'HEURE DU HOUBLONNAGE À CRU !",
            dump: "🧪 C'EST L'HEURE DE PURGER LA LEVURE !",
        ...
        support: {
            title_bug: "Signaler un bug",
            title_idea: "Proposer une idée",
            desc: "Tes idées et rapports de bugs nous aident à brasser une meilleure application !",
            email: "Ton e-mail",
            subject: "Sujet",
            message: "Message",
            btn_send: "Envoyer le message",
            success_title: "Envoyé !",
            success_desc: "Merci pour ton retour. Nous te recontacterons !",
            sub_bug: "Rapport de bug - YeastMaster",
            sub_idea: "Demande de fonctionnalité - YeastMaster",
            message_placeholder: "Dis-nous ce qui s'est passé ou partage ton idée..."
        },

        libTour: {
            noYeast: "Sélectionne ou ajoute d'abord des levures pour voir la visite !",
            exitConfirm: "QUITTER LA VISITE ?",
            step1: "Double-clique sur une carte pour en savoir plus sur la souche. Un simple clic pour la sélectionner pour ton appareil !",
            step2: "Voici les profils matériels. Ils contrôlent automatiquement les températures de ton frigo.",
            step3: "Clique pour développer le profil et voir les étapes de température !",
            step4: "Envie de modifier un profil ? Clique sur « Modifier dans le Profileur » pour ajouter des houblonnages à cru ou des alarmes de soutirage !",
            step5: "Bienvenue dans le Profileur ! Ici, tu peux attraper et faire glisser les points pour façonner ta courbe de fermentation.",
            step6: "Règle tes alarmes pour le houblonnage à cru, le retrait des houblons et le soutirage ! Elles apparaîtront sur ta chronologie et t'alerteront le moment venu.",
            step7: "Une fois enregistré, ton profil modifié arrive en bas de la bibliothèque avec une étoile ★, prêt à être synchronisé !",
            step8: "Dans la bibliothèque, tu as la possibilité d'ajouter tes propres captures uniques et levures sauvages.",
            step9: "Tu peux suivre les dates de capture, les origines et tenir des notes de labo personnelles pour chaque levure sauvage que tu trouves !",
    ...
    es: {
        ...
        dashboard: {
            ...
            no_data_hint: "Aún no se han recibido datos. Asegúrate de que el dispositivo esté encendido y conectado al WiFi — y revisa que la dirección MAC sea correcta.",
            start: "INICIO",
            ready: "LISTA",
            air: "Aire:",
            phase_label: "Fase:",
        ...
        privacy: {
            ...
            s1_body: "YeastMaster es un servicio de monitorización de fermentación gestionado por AY Tech. Para cualquier duda sobre tus datos personales, escribe a: <a href='mailto:yeastmaster101@gmail.com' style='color: var(--accent-color);'>yeastmaster101@gmail.com</a>",
